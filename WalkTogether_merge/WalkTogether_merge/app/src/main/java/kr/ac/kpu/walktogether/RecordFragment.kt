...
class RecordFragment : Fragment() {
    ...
    private fun endRecord() {
        ...
        val today = SimpleDateFormat("dd", Locale.KOREA).format(Date(System.currentTimeMillis()))
        ...
        // 처음 저장    document
        firestore?.collection("WalkInterval")?.document("$today@${user?.uid!!}")?.set(recordDTO)?.addOnCompleteListener { task ->
            Log.d("zxzxzx", "zxzxzx")
